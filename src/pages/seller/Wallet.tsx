      ...
      <div className="mt-4 p-4 md:p-10 lg:flex lg:gap-x-12">
        ...
        <div className="w-full lg:w-3/5">
          <div className="flex flex-col md:flex-row md:justify-center lg:justify-start md:items-center gap-y-8 gap-x-24">
            ...
            <div className="flex gap-x-3 bg-[#FFFFFF] py-4 pr-4 rounded-md">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">
                  <span>N</span> 22,OOO,OOO
                </p>
                <div className="flex items-center gap-x-2 mt-2">
                  <div className="p-1 bg-[#E6580040] text-[#E65800] rounded-2xl">
            ...
            <div className="flex gap-x-3  bg-[#FFFFFF] py-4 pr-4 rounded-md">
              ...
              <div>
                ...
                <div className="flex items-center gap-x-2 mt-2">
                  <div className="p-1 bg-[#14199C40] text-[#14199C] rounded-2xl">
          ...
          <div className="mt-24 bg-[#ffffff] p-6 rounded-md">
            <div className="text-[#14199C] font-bold text-sm md:text-lg">
              Card Details
            </div>
            <div className="grid grid-cols-2 justify-between gap-y-4 mt-4">
              <div>
                <div className="text-[#14199C] font-bold mb-2 text-xs md:text-sm">
                  Card Name
                </div>
            ...
            <div className="mt-8">
              <button
                ...
                className="w-full rounded-lg flex justify-center px-4 sm:px-5 py-2 sm:py-2.5 text-white text-sm bg-defaultOrange"
              >
                Add New Card
              </button>
            </div>
        ...
        <div className="w-full lg:w-2/5 sm:mt-10 lg:mt-4">
          ...
          <div className=" bg-[#ffffff] p-6 rounded-md">
            <div className="flex flex-col items-center gap-y-1">
              ...
              <p className="text-4xl font-bold">
                <span>N</span> 22,000,000
              </p>
              <div className="flex items-center gap-x-2">
                <div className="p-1 bg-[#34A85340] text-[#34A853] rounded-2xl">
            ...
            <div className="flex justify-center items-center gap-x-4 mt-6">
              <button
                ...
                className="rounded-lg flex items-center gap-x-2 px-4 sm:px-5 py-2 sm:py-2.5 text-defaultOrange text-sm border-defaultOrange border-[1px]"
              >
                <span>Deposit</span>
                <img
              ...
              <button
                ...
                className="rounded-lg flex items-center gap-x-2 px-2 sm:px-4 py-2 sm:py-2.5 text-defaultOrange text-sm border-defaultOrange border-[1px]"
              >
                <span>Withdraw</span>
                <img
                  className="w-[20px] h-[18px]"
          ...
          <div className="mt-10">
            <div className="flex justify-between items-center">
              ...
              <div
                onClick={() => handleViewTransactionHistry()}
                className="cursor-pointer hover:underline text-[#14199C] text-sm"
              >
                View All
              </div>
            </div>
            ...
            <div className="mt-2">
              {[1, 2, 3].map(() => (
                <div className="flex items-center justify-between p-2 text-[10px] md:text-xs mb-4 bg-[#ffffff] p-4 rounded-md">
                  ...
                  <div className="text-[#00000099]">04 April 2025</div>
                </div>
              ))}
            </div>
...
function WalletIllustration() {
  ...
  return (
    <div
      ...
      className="wallet transition-all duration-300 ease-in-out"
    >
      <div
        id="walletbehind"
        className="walletback -rotate-[8deg] invisible md:visible flex flex-col w-60 h-36 md:w-80 md:h-52 lg:w-96 lg:h-60 rounded-xl transition-all duration-500 ease-in-out relative"
      >
