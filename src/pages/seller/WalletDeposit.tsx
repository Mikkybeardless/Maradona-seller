        ...
        <div className="lg:w-1/2 flex flex-col gap-y-10 mt-8 mb-20">
            ...
            <div className="bg-white p-4 border border-[#D1D1D1] rounded-lg flex justify-between">
                <div className="flex gap-x-4 w-2/3">
                    ...
                    <div>
                        <p className="text-lg">Debit Card</p>
                        <p className="text-[#6D6D6D] font-inter text-xs font-light">Pay instantly and securely with your credit/debit card. You will be redirected to another page.</p>
                    </div>
                </div>
                <div>
            ...
            <div className="bg-white p-4 border border-[#D1D1D1] rounded-lg flex justify-between">
                <div className="flex gap-x-4 w-2/3">
                    ...
                    <div>
                        <p className="text-lg">Paystack</p>
                        <p className="text-[#6D6D6D] font-inter text-xs font-light">Pay instantly and securely with your credit/debit card. You will be redirected to another page.</p>
                    </div>
                </div>
                <div>
            ...
            <div className="bg-white p-4 border border-[#D1D1D1] rounded-lg flex justify-between">
                <div className="flex gap-x-4 w-2/3">
                    ...
                    <div>
                        <p className="text-lg">Flutterwave</p>
                        <p className="text-[#6D6D6D] font-inter text-xs font-light">Instant and effortless payment.</p>
                    </div>
                </div>
                <div>
