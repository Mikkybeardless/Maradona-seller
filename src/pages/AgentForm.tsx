  ...
  return (
    <div className="w-full h-screen overflow-y-auto overflow-x-hidden custom-scrollbar flex flex-col bg-[#F7F7F7] p-8">
        ...
        <div className="flex flex-col mt-10 items-center gap-y-10">
                ...
                Thank you for your interest in becoming an agent on our e-commerce platform! Please fill out the form below to register
                </p>
                ...
                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-3 justify-between md:gap-x-5 lg:gap-x-10">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-x-4">
                                <div className="flex items-center gap-x-2 mt-4">
                                    <input className="" type="radio" name="gender"/><span>Male</span>
                                </div>
                                
                                <div className="flex items-center gap-x-2 mt-4">
                                    <input className="" type="radio" name="gender"/><span>Female</span>
                                </div>
                                
                                <div className="flex items-center gap-x-2 mt-4">
                                    <input className="" type="radio" name="gender"/><span>Other</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-xs flex flex-col gap-y-8 justify-between">
                        ...
                        <div>
                            ...
                            <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                <input className="bg-none outline-none text-[#A3A3B3] w-full" type="number" placeholder=""/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="text-xs flex flex-col gap-y-8">
                      ...
                      <div>
                        <div className="mb-1">Products/Services You Plan to Sell:</div>
                        <div>
                ...
                <div className="grid grid-cols-1 gap-y-2 md:grid-cols-3 justify-between md:gap-x-5 lg:gap-x-10">
                  <div className="text-xs flex flex-col gap-y-8">
                    <div>
                        ...
                        <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                            <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Bank Name:"/>
                        </div>
                    </div>
                    <div>
                        <div className="mb-1">Account Name:</div>
                        <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                            <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Account Name"/>
                        </div>
                    </div>
                  </div>
                  ...
                  <div className="text-xs flex flex-col gap-y-8 justify-between">
                    <div>
                      ...
                      <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                          <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Bank Account Number"/>
                      </div>
                    </div>
                    <div>
                      <div className="mb-1">Preferred Contact Method::</div>
                      <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                          <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Preferred Contact Method:"/>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="text-xs flex flex-col gap-y-8 justify-between">
                    <div>
                      ...
                      <div className="flex items-center gap-x-4">
                        <div className="flex items-center gap-x-2 mt-4">
                            <input className="" type="radio" name="training"/><span>Yes</span>
                        </div>
                        
                        <div className="flex items-center gap-x-2 mt-4">
                            <input className="" type="radio" name="training"/><span>No</span>
                        </div>
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="flex items-center gap-x-4">
                        <div className="flex items-center gap-x-2 mt-4">
                            <input className="" type="radio" name="training-type"/><span>Physically</span>
                        </div>
                        
                        <div className="flex items-center gap-x-2 mt-4">
                            <input className="" type="radio" name="training-type"/><span>Virtually</span>
                        </div>
                      </div>
                    </div>
                  </div>
