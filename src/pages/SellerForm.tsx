...
export default function SellerForm() {
  ...
  const [currentTab, setCurrentTab] = useState(1);
      ...
      const handleProductTypeChange = (event: SelectChangeEvent<typeof productName>) => {
        const {
          target: { value },
        } = event;
        setProductName(
                ...
                <div className="w-full lg:w-5/6">
                    ...
                    <div className="grid grid-cols-1 gap-y-2 md:grid-cols-3 justify-between md:gap-x-5 lg:gap-x-10">
                        <div className="text-xs flex flex-col gap-y-8">
                            ...
                            <div>
                                <div className="mb-1">Business Registration No (if applicable):</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Reg No."/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-xs flex flex-col gap-y-8 justify-between">
                            ...
                            <div>
                                ...
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="https://"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="text-xs flex flex-col gap-y-8">
                            ...
                            <div>
                                ...
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                  <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="NIN"/>
                                </div>
                            </div>
                            <div>
                    ...
                    <div className="grid grid-cols-1 gap-y-2 md:grid-cols-3 justify-between md:gap-x-5 lg:gap-x-10">
                        <div className="text-xs flex flex-col gap-y-8 justify-between">
                          ...
                          <div>
                            ...
                            <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                <textarea className="bg-none outline-none text-[#A3A3B3]" rows={5} placeholder=""></textarea>
                            </div>
                          </div>
                          <div>
                        ...
                        <div className="text-xs flex flex-col gap-y-8 justify-between">
                            <div>
                                ...
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Online market place"/>
                                </div>
                            </div>
                            <div>
                                <div className="mb-1">Pricing Strategy:</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Competitive Pricing"/>
                                </div>
                            </div>
                            <div>
                                <div className="mb-1">Promotional Activities:</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Discount"/>
                                </div>
                            </div>
                            <div>
                                <div className="mb-1">Shipping Method:</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Third Party Logistics"/>
                                </div>
                            </div>
                            <div>
                                <div className="mb-1">Marketing Strategy:</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Social media"/>
                                </div>
                            </div>
                            <div>
                        ...
                        <div className="text-xs flex flex-col gap-y-8 justify-between">
                            ...
                            <div>
                                <div className="mb-1">Terms of Sale (e.g., payment, shipping terms)</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <textarea className="bg-none outline-none text-[#A3A3B3]" rows={8} placeholder=""></textarea>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
                                    <input className="bg-none outline-none text-[#A3A3B3] w-full" type="text" placeholder="Time"/>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex flex-col gap-y-8 text-xs w-full lg:w-1/2 gap-y-8">
                            <div>
                                <div className="mb-1">Upload Documents (e.g., business registration, product catalog, photos):</div>
                                <div className="text-[#6F6F6F] bg-[#FFFFFF] border border-[#DED9DD] px-10 py-14 rounded-lg flex justify-center items-center">
                                  <div {...getRootProps({className: 'dropzone'})}>
                                    <input {...getInputProps()} />
                                    <div className="font-light"><FiUploadCloud size={80}/></div>
                            ...
                            <div>
                                <div className="mb-1">Additional Comments or Questions:</div>
                                <div className="bg-[#FFFFFF] border border-[#DED9DD] p-2 rounded">
