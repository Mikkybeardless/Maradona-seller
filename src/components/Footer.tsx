...
export default function Footer() {
  return (
    <section
      id="footer"
      className="w-full pt-16 pb-8 mt-[8rem] md:mt-[10rem] relative flex justify-center bg-[#0C0F53]"
    >
      ...
      <div className="w-full z-20 bg-transparent px-6 md:px-12">
        ...
        <div className="px-14 pt-5 flex flex-col md:flex-row items-center border-t border-t-white gap-4 md:gap-0">
          ...
          <div className="flex gap-x-3.5 md:mr-8">
            <FaXTwitter className="cursor-pointer w-5 h-5" color="white" />
            <BiLogoFacebookSquare
              className="cursor-pointer w-5 h-5"
              color="white"
            />
            <FaWhatsapp className="cursor-pointer w-5 h-5" color="white" />
            <FaInstagram className="cursor-pointer w-5 h-5" color="white" />
          </div>
